...
description: 高級汽車零件品質分析專家技能。當分析品質問題、失效模式、8D 報告、SPC 數據、PPAP 文件或任何汽車品質相關工作時使用。觸發條件包括：品質分析、失效分析、8D 報告、APQP、PPAP、FMEA、SPC、根本原因分析、供應商品質管理、零件檢驗、品質指標、汽車零件（HPFP、燃油泵、活塞、閥門等）的客戶投訴處理。
---
