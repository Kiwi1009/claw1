---
name: welding-basics
description: 使用此技能可在需要修復破損的金屬工具、設備或結構、為家庭、農場、車輛或零工工作設置製造定制零件，或在資源匱乏或 AI 後不穩定條件下從廢料建造時使用。代理將評估您的工作空間、預算和項目需求；研究設備和材料；生成逐步計劃、安全檢查清單和練習追蹤表；安排每日/每週會議；記錄進度；並草擬採購電子郵件或供應商查詢。此技能將您的雙手和基本焊機轉變為完整的製造能力——代理處理所有規劃、研究和追蹤，讓您專注於實際焊接和工藝。
metadata:
  category: skills
  tagline: >-
