...
description: 為多地點零售商提供需求預測、安全庫存優化、補貨規劃與促銷提升估算的編碼專業知識。由擁有15年以上經驗、管理數百個SKU的需求規劃師提供資訊。內容涵蓋預測方法選擇、ABC/XYZ 分析、季節轉換管理與供應商談判框架。適用於需求預測、安全庫存設定、補貨規劃、促銷管理或庫存水平優化時。
license: Apache-2.0
version: 1.0.0
