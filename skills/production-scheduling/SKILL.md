...
description: 此技能為製造排程、工作序列、線路平衡、換線優化及瓶頸解決的編碼專業知識，適用於離散與批量製造。由擁有15+年經驗的排程專家提供資訊。內容包含 TOC/鼓-緩衝-繩、SMED、OEE 分析、中斷應變框架，以及 ERP/MES 互動模式。當進行生產排程、解決瓶頸、優化換線、應對中斷或平衡製造線時使用。
license: Apache-2.0
version: 1.0.0
