---
name: cad-viewer
description: 此技能應於使用者欲閱讀、分析或處理 CAD DWG/DXF 繪圖檔時使用。觸發詞包括：DWG、DXF、CAD 繪圖、繪圖分析、圖層、區塊、實體、截圖、距離計算、繪圖審核、電氣圖、配電箱、單線圖，或任何提及 .dwg/.dxf 檔案。此技能提供全面的 CAD 繪圖分析功能，包括閱讀檔案元資料、列出圖層與實體、分析區塊定義、計算實體間距離、捕捉特定區域或實體的截圖，以及審核繪圖合規性。
---
