---
name: rohoon-6sigma
description: Rohoon 六西格瑪專業支援。基於 AIAG-VDA SPC Manual、MSA Manual 以及 Six Sigma/Lean methodology。提供 DMAIC/DMADV tools、SPC control charts、process capability indices (Pm/Pmk, Pp/Ppk, Cp/Cpk)、MSA analysis (GR&R/Bias/Linearity/Stability)、DOE (Full/Partial Factorial/RSM/Taguchi)、FMEA、5S/VSM 等等。適用於 automotive quality management、process optimization、supplier assessment。
---
